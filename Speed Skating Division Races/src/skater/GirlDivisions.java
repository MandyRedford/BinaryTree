...
/*Mandy Redford
 * for girl gender selection offers for you to choose your division then outputs in console what distances you race
 * 	
 */

public class GirlDivisions implements ActionListener {
	...
	//Divisions
	final String[] names={"Tiny Tot", "Primary", "Juvienile", "Elementry", "Freshmen", "Sophmore","Juinor", "Senior", "Classic"};
		
		divisions=new JComboBox<String>(names);
		divisions.setMaximumRowCount(9);

	//frame	
	JFrame divframe;
	divframe= new JFrame ();
	divframe.setSize(100,500);
	divframe.setTitle("Girl");
	...
	public void actionPerformed(ActionEvent e) {
		...
		//add more divisions  
		  ...
		  File logfile = new File("mylog.txt");
			...
			for (int k=0; k<1; k++) {
				int i= 0;
				outStream.println("girls" + (names[i]));}
