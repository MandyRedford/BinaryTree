...
public class DrawingFemale extends JPanel{
	/*Mandy Redford
	 * creates a pink circle to symbolize that Female was selected
	 * 	
	 */
	...
	public static void diamond(Graphics g) {
		//drawas the shape, gooten from http://www.cs.umb.edu/~laur/Java/Solitaire/Solitaire.java
			 g.setColor(Color.pink);//sets the color for the next oval 
